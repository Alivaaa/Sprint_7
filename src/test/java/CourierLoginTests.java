...
public class CourierLoginTests {
    ...
    private final Courier validCourier = getRandomCourierDataLoginPassword();
    ...
    public void testCourierLoginWithoutLogin() {
        verifyLoginResponse(getRandomCourierDataEmptyLoginPassword(),
    ...
    public void testCourierLoginWithoutPassword() {
        verifyLoginResponse(getRandomCourierDataLoginEmptyPassword(),
                HttpURLConnection.HTTP_BAD_REQUEST,
                "Недостаточно данных для входа");
    }
    ...
    public void testCourierLoginWithIncorrectLogin() {
        courierApiSteps.createCourier();
        verifyLoginResponse(new Courier("InvalidLogin123", validCourier.getPassword()),
    ...
    public void testCourierLoginWithIncorrectPassword() {
        courierApiSteps.createCourier();
        verifyLoginResponse(new Courier(validCourier.getLogin(), "WrongPassword"),
                HttpURLConnection.HTTP_NOT_FOUND,
                "Учетная запись не найдена");
    }
    ...
    public void testLoginUnknownCourier() {
        ...
        verifyLoginResponse(validCourier,
                HttpURLConnection.HTTP_NOT_FOUND,
                "Учетная запись не найдена");
    }
